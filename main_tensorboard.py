...
def train(dataloader, model, optimizer, log, num_train, TestImgLoader):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for batch_idx, (imgL, imgR, disp_L) in enumerate(dataloader):
            ...
            for idx in range(stages):
                ...
                writer.add_scalar('Loss/train'+str(idx), loss[idx].item(), global_step)

            # writer.add_scalar('Loss/train', loss[idx].item(), global_step)


            global_step += 1

            if global_step % (num_train // (10 * args.train_bsize)) == 0:
